		...
		<div class="bg-dark pl-32 pr-32 height-full">
			<div class="vertical-top-no bg-dark above pt40 pb24">
				<a href="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    <?php else: ?>
					<img class="mb40 mb-xs-24" alt="<?php echo esc_attr(get_bloginfo('title')); ?>" src="<?php echo esc_url($logos['logo_light']); ?>" srcset="<?php echo esc_attr($logos['logo_light_srcset']); ?>" />
					<?php endif; ?>
				</a>
			</div>
