<section class="projects pt48">
    <div class="container">
        ...
        ?>
        <div id="<?php echo esc_attr($project_id) ?>" class="row grid-blog masonry masonry-show project-content project-masonry">
            <div class="grid-sizer col-sm-3"></div>
            <?php 
            if ( have_posts() ) : 
                while ( have_posts() ) : the_post();
                    get_template_part( 'templates/portfolio/inc', 'modern-4col' );
                endwhile;
            else :
