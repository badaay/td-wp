...
?>
<li class="item image-round-100 move-cursor">
    <div class="testimonial-avatar">
        <?php the_post_thumbnail( 'full', array('class' => 'image-m inline-block mb48') ); ?>
    </div>
	<?php echo !empty($testimonial_content) ? '<div class="content">'.$testimonial_content.'</div>' : ''; ?>
